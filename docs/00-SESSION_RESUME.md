...
### 우선순위 1: Program Domain 완료
1. **ProgramRepository 테스트 작성** (이미 구현됨)
2. **ProgramCompetencyRepository 구현 및 테스트**

### 우선순위 2: Mileage Domain
3. MileageTransactionRepository 구현
4. MileageRuleRepository 구현
